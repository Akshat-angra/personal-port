  ...
  return (
      <div id="about">
        <div className="about-section relative py-8 px-6 flex flex-col items-center justify-center text-center bg-muted/50">
          <GridBackground />
          <motion.h2
              className="text-4xl font-bold mb-12 fonrob relative"
          ...
          >
            ...
            <img
                ...
                alt="highlight"
                className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-40 md:w-96"
            />
          </motion.h2>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10">
            ...
            <motion.div
                className="text-section md:w-1/2 text-center md:text-left border-t-4 border-l-4 border-blue-300 pt-6 pl-8 rounded-xl"
                initial={{ opacity: 0, y: 100 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8 }}
                viewport={{ once: true }}
